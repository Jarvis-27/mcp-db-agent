...
export const siteDescription =
  'PlainQuery is an open-source MCP server and hosted app that lets ChatGPT, Cursor, VS Code, and Claude Desktop query Postgres or SQLite in plain English with read-only SQL validation.'
...
export const softwareJsonLd = {
  ...
  featureList: [
    'Ask Postgres and SQLite databases questions in plain English',
